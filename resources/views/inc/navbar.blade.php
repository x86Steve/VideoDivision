        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style ="position: relative; padding-left: 50px;">
                    <img src="{{Config::get('customfilelocations.locations.avatars')}}{{Auth::user()->avatar}}" onerror="this.src= '{{Config::get('customfilelocations.locations.avatars')}}default.png'" style="width: 32px; height: 32px; position: absolute; top:5px; left: 10px; border-radius: 50%">Hey, {{ Auth::user()->username }}! <span class="badge badge-success">{{helper_GetNewMessagesCount() > 0 ? "new messages" : "" }}</a>
                <div class="dropdown-menu" aria-labelledby="dropdown01">
